...
public class RoomCreationStepDefinitions {
    ...
    public void get_the_response_and_validate() throws JsonProcessingException {
        ...
        assertEquals(expectedDataPojo.getPrice()+"", actualDataPojo.getPrice()+""); //uyum sorunu (float) oldugu icin cast yaptim
        ...
        assertEquals(expectedDataPojo.getPrice()+"", actualDataPojoMapper.getPrice()+"");//uyum sorunu (float) oldugu icin cast yaptim
        ...
        assertEquals(expectedDataPojo.getPrice()+"", actualDataPojoGson.getPrice()+"");//uyum sorunu (float) oldugu icin cast yaptim
